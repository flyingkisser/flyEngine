...
int main(int argc, char **argv) {
    setCurrentWorkDir("/Users/wumingzhou/Documents/flyEngine/");
    if(!glfwInit()){
...
//    // ------------------------------------
////    Shader ourShader("res/shader/4.2.texture.vs", "res/shader/4.2.texture.fs");
//    int shaderID=shaderMgr::createShader("res/shader/4.2.texture.vs", "res/shader/4.2.texture.fs");
//
...
//    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
//    // load image, create texture and generate mipmaps
//    data = stbi_load("res/smile.png", &width, &height, &nrChannels, 0);
//    if (data)
//    {
