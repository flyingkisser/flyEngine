...
void test_PBR_ibl_1(){
    ...
    shader* shRenderSixFace=new shader("res/shader/equirectangular2cubemap.vs","res/shader/equirectangular2cubemap.fs");
    
    cubeTex* cubeRenderSixFace=new cubeTex(st.texID);
    cubeRenderSixFace->init();
    cubeRenderSixFace->setPosition(glm::vec3(0,0,0));
    ...
    cubeTex* cubeBackground=new cubeTex(st.texID);
    cubeBackground->init();
    cubeBackground->setPosition(glm::vec3(0,0,0));
    cubeBackground->setShader(shBackground);
    world::getInstance()->addChild(cubeBackground);
