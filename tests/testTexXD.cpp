...
static void beginDraw2DByJpg(){
    struct_texture* structTex=jpgUtil::loadFile("./res/test.jpeg");
    if(!structTex)
        return;
...
void testTex2DJpg() {
    testInitWindow3D("openGL TexImage2D 2d quad test", beginDraw2DByJpg);
    windowLoop();
}
...
//void testTex3D() {
//    testInitWindow3D("openGL TexImage3D test", beginDrawTex2DByJpg);
//    windowLoop();
//}
