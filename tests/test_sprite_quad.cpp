...
//    quadSize* sp=new quadSize(tex->getTextureID(),tex->getWidth(),tex->getHeight());
    
    quadSize* sp1=new quadSize("res/heightmap/river_heightmap.png");
    
    sp1->setPosition(glm::vec3(0,0,-1));
//    sp1->setRotation(glm::vec3(0,30,0));
