...
void test_PBR_cubeTex(){
    ...
    texture2* tex0=new texture2("./res/ironball/albedo.png");
    texture2* tex1=new texture2("./res/ironball/normal.png");
    texture2* tex2=new texture2("./res/ironball/metallic.png");
    texture2* tex3=new texture2("./res/ironball/roughness.png");
    texture2* tex4=new texture2("./res/ironball/ao.png");
    tex0->init();
    tex1->init();
    tex2->init();
    tex3->init();
