...
//    shader* shRenderSixFace=new shader("res/shader/cubemap.vs", "res/shader/equirectangular2cubemap.fs");
    ...
    shader* equirectangularToCubemapShader=new shader("res/shader/2.1.2.cubemap.vs", "res/shader/2.1.2.equirectangular_to_cubemap.fs");
    shader* irradianceShader=new shader("res/shader/2.1.2.cubemap.vs", "res/shader/2.1.2.irradiance_convolution.fs");
...
//    st.texID=envCubemap;
    equirectangularToCubemapShader->use();
      ...
      for (unsigned int i = 0; i < 6; ++i)
      {
          equirectangularToCubemapShader->setMat4("view", viewArr[i]);
          glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_CUBE_MAP_POSITIVE_X + i, st.texID, 0);
          glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
